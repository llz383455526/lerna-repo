<template>
  <div>
    <el-col :span="16"
      v-if="detail.quoteFeeContent && detail.quoteFeeContent.quoteFeeType">
      ...
      <template v-else-if="detail.quoteFeeContent.quoteFeeType == 'nonflow'">
        ...
        <div v-for="(e, i) in detail.quoteFeeContent.stepwiseList"
          :key="i">
          <div class="pl10">
            <span>
      ...
      <template v-else-if="detail.quoteFeeContent.quoteFeeType == 'flow'">
        ...
        <div class="pl10">
          ...
          <div class="pl10"
            v-for="e in detail.quoteFeeContent.serviceCompanyRateList"
