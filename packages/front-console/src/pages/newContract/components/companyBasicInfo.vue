<template>
  <div>
    ...
    <el-form-item label="企业对接方式"
      style="width:100%;"
      prop="isFromOutApp"
      v-if="contractModel.workflowType === 'create_sale_contract' || contractModel.workflowType === 'create_ns_sale_contract'">
      <el-select style="width:450px;"
        v-model="contractModel.contractForm.isFromOutApp">
        <el-option v-for="(item, key) in list"
          :key="key"
          :label="item.label"
    ...
    <el-form-item label="企业名称"
      ...
      <el-select v-if="checkRight(permissions, 'sysmgr-web:/data-permission-tag/sales-contract-interim-company-flag')"
        v-model="contractModel.contractForm.customerName"
        filterable
        style="width:450px;">
        <el-option v-for="e in companyList"
          :key="e.value"
          :value="e.text"
    ...
    <el-form-item label="企业地址"
      prop="areaName">
      <el-input v-model="contractModel.contractForm.areaName"
        style="width:450px;"></el-input>
    </el-form-item>
    <el-form-item label="法定代表人"
      prop="customLegalPerson">
      <el-input v-model="contractModel.contractForm.customLegalPerson"
        style="width:450px;"></el-input>
    </el-form-item>
    <el-form-item label="系统操作人"
      prop="customCollector">
      <el-input v-model="contractModel.contractForm.customCollector"
        style="width:450px;"
        :disabled="isChange"></el-input>
    </el-form-item>
    <el-form-item label="操作人手机"
      prop="customCollectorPhone">
      <el-input v-model="contractModel.contractForm.customCollectorPhone"
        style="width:450px;"
        maxlength="11"
        :disabled="isChange"></el-input>
    </el-form-item>
    <el-form-item label="操作人邮箱"
      prop="customMail1">
      <el-input v-model="contractModel.contractForm.customMail1"
        style="width:450px;"></el-input>
    </el-form-item>
    <el-form-item label="企业负责人">
      <el-input v-model="contractModel.contractForm.companyChargeName"
        style="width:450px;"></el-input>
    </el-form-item>
    <el-form-item label="负责人手机">
      <el-input v-model="contractModel.contractForm.companyChargePhone"
        style="width:450px;"></el-input>
    </el-form-item>
    <el-form-item label="负责人邮箱">
      <el-input v-model="contractModel.contractForm.companyChargeMail"
        style="width:450px;"></el-input>
    </el-form-item>
    ...
    <el-form-item label="负责人地址"
      prop="customCollectorAddr">
      <el-input v-model="contractModel.contractForm.customCollectorAddr"
        style="width:450px;"></el-input>
    </el-form-item>
  </div>
</template>
