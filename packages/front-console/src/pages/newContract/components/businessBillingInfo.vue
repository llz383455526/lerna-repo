<template>
    <div>
        ...
        <el-form-item label="开票企业名称" prop="invoiceCompanyName">
            <el-input v-model="contractModel.contractForm.invoiceCompanyName" style="width:450px;" @focus="focusInvoiceCompanyName"></el-input>
        </el-form-item>
        <el-form-item label="纳税人识别号" prop="customTaxIdcd" >
            <el-input v-model="contractModel.contractForm.customTaxIdcd" style="width:450px;"></el-input>
        </el-form-item>
        <el-form-item label="开票企业地址" prop="invoiceAddress">
            <el-input v-model="contractModel.contractForm.invoiceAddress" style="width:450px;" @focus="focusAreaName"></el-input>
        </el-form-item>
        <el-form-item label="企业电话" prop="customPhone">
            <el-input v-model="contractModel.contractForm.customPhone" style="width:450px;"></el-input>
        </el-form-item>
        <el-form-item label="开户银行" prop="customBankName">
            <el-input v-model="contractModel.contractForm.customBankName" style="width:450px;"></el-input>
        </el-form-item>
        <el-form-item label="银行账号" prop="customBankAccount">
            <el-input v-model="contractModel.contractForm.customBankAccount" style="width:450px;"></el-input>
        </el-form-item>
