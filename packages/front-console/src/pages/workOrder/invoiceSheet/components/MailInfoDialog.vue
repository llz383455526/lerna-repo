<template>
  <el-dialog title="编辑邮寄信息"
:visible.sync="showSync" :close-on-click-modal="false" width="800px">
    <el-form ref="mailInfo"
label-width="200px" class="mail-form" :model="mailInfo">
      <el-form-item label="收票人"
prop="name">
        <el-input v-model="mailInfo.collector" />
      </el-form-item>
      <el-form-item label="收票人电话"
prop="taxIdcd">
        <el-input v-model="mailInfo.collectorPhone" />
      </el-form-item>
      <el-form-item label="收票人地址"
prop="addr">
        <el-input v-model="mailInfo.collectorAddr" />
      </el-form-item>
      <el-form-item>
        ...
        if (valid) {
          ...
          const editurl =
            ...
            this.$route.query.businessType === "subcontract"
              ? invoiceApi.editSubcontractCustomerInfo
              : invoiceApi.editCustomerInfo;
          post(editurl, this.mailInfo).then(res => {
