...
prop="taxIdcd">
        <el-input v-model="invoiceInfo.taxIdcd" />
      </el-form-item>
      <el-form-item label="公司地址"
prop="addr">
        <el-input v-model="invoiceInfo.addr" />
      </el-form-item>
...
prop="bankName">
        <el-input v-model="invoiceInfo.bankName" />
      </el-form-item>
      <el-form-item label="银行账号"
prop="bankAccount">
        <el-input v-model.number="invoiceInfo.bankAccount" />
      </el-form-item>
      <el-form-item>
    ...
    onSubmit(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          post(editurl, this.invoiceInfo).then(res => {
