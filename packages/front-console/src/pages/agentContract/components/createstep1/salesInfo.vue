...
<template>
    <div>
        ...
        <el-form-item label="销售姓名" :prop="`${propName}.salesId`">
            <el-select v-model="contract.datas.salesInfo.salesId" filterable placeholder="请选择" style="width: 400px;" @change="changeSales">
...
export default {
    ...
    methods: {
        changeSales(ev) {
            ...
            this.contract.datas.salesInfo.salesName = obj.name
            // this.contract.datas.salesInfo.mobilePhone = obj.mobilePhone
        }
    },
    created() {
