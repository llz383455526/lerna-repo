<template>
  <div class="client-risk-rule">
    ...
    <div>
      <el-button type="primary" @click="addBtnClick" size="mini">新增限额规则</el-button>
    </div>
    <br>
    <el-table
      :data="tableData"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addBtnClick() {
        this.$router.push('/main/orderManager/addEnterprise')
      },
      showClick(item) {
        this.$router.push(`/main/orderManager/costLimitDetail?id=${item.companyId}`)
      },
