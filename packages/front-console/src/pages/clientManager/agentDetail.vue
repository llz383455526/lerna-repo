  ...
  <div class="r_main">
    ...
    <el-table :data="detail.agentContractList">
      ...
      <el-table-column label="文件原件">
        <template slot-scope="scope">
          <a v-for="e in scope.row.attachments"
             :key="e.refId"
      ...
      <el-table-column label="代理推广费率"
                       prop="quoteFeeName" />
      <el-table-column label="操作人"
                       prop="createByName" />
      <el-table-column label="操作">
        <template slot-scope="scope">
          <a :href="`/api/contract-web/agent-contract/download-agent-contract-attachments?contractId=${scope.row.id}`"
             target="_blank"
             rel="noopener noreferrer"
