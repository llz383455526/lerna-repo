<template>
    <div class="r_main">
        ...
        <div class="box">
            <el-row :gutter="20">
                <el-col :span="20">
                    <el-col :span="4" class="right">代理商名称</el-col>
                    <el-col :span="10" style="word-wrap: break-word;">{{detail.fullName}}</el-col>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                <el-col :span="20">
                    <el-col :span="4" class="right">代理商简称</el-col>
                    <el-col :span="10" style="word-wrap: break-word;">{{detail.name}}</el-col>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                <el-col :span="20">
                    <el-col :span="4" class="right">渠道经理</el-col>
                    <el-col :span="10" style="word-wrap: break-word;">{{detail.chargeByName}}</el-col>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                <el-col :span="20">
                    <el-col :span="4" class="right">所在省份</el-col>
                    <el-col :span="10" style="word-wrap: break-word;">{{detail.province}}</el-col>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                <el-col :span="20">
                    <el-col :span="4" class="right">所在城市</el-col>
                    <el-col :span="10" style="word-wrap: break-word;">{{detail.city}}</el-col>
                </el-col>
            </el-row>
        </div>
