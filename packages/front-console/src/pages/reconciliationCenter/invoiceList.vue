    ...
    <div class="main-container">
        <el-form :inline="true" :model="formSearch" :rules="formSearch" ref="formSearch">
            <el-form-item label="客户公司:"   size="small" prop="customCompanyId">
                <el-select v-model="formSearch.customCompanyId">
        ...
        <div class="table-container">
            <el-table :data="tableList.list">
                ...
                <el-table-column prop="totalTaxAmount" label="税额（元）">
                    <template slot-scope="scope">{{scope.row.totalTaxAmount | formatMoney}}</template>
                </el-table-column>
            </el-table>
        </div>
	...
	export default {
        ...
        methods: {
	        ...
	        getList() {
                ...
                post('/api/invoice-web/invoice/custom-company-invoice-statistics', options)
                    .then(result => {
	        ...
	        exportFile() {
		        ...
		        window.location.href = `${baseUrl}/api/invoice-web/invoice/export-custom-invoice-statistics?${urlEncode(formSearch)}`
	        },
            getCompanyData() {
