<template>
    <div class="main">
        ...
        <div class="m30">
            <el-upload :action="uploadUrl" :on-error="handleError" :before-upload="handleBeforeUpload" :http-request="handleHttpRequest" multiple accept=".docx, .xlsx, .xls" :show-file-list="false" :file-list="fileList">
                <el-button size="small" type="primary">点击上传</el-button>
            </el-upload>
            <el-table class="mt20" :data="form.attachments">
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" @click="deleteFile(scope.row.downloadCode, scope.$index)">
                            删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-button class="mt20" size="small" type="primary" @click="$router.back()">返回</el-button>
        </div>
    </div>
</template>
<script>
